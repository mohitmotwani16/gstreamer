...
int main(int argc, char *argv[]) {
  ...
  for (walk = list; walk != NULL; walk = g_list_next (walk)) {
    ...
    if (selected_factory == NULL || g_str_has_prefix (name, "libvisual_corona")) {
  ...
  /* Build the pipeline */
  pipeline = gst_parse_launch ("playbin uri=http://hcmaslov.d-real.sci-nnov.ru/public/mp3/Queen/Queen%20'We%20Will%20Rock%20You'.mp3", NULL);
